...
if (!js.includes("requestAnimationFrame") || !js.includes('motionProfile = "rdj"') || !html.includes('data-motion-profile="rdj"')) {
...
console.log("R Dwiejhaya Barbershop brand-DNA build check passed.");
